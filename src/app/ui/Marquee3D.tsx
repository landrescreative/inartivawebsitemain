...
const Marquee3D = () => {
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center gap-4 overflow-hidden rounded-lg  px-20">
      <div className="flex flex-row gap-4 [perspective:600px]">
        <Marquee
          className="h-[800px] justify-center overflow-hidden [--duration:60s] [--gap:1rem]"
          vertical
          style={{
            transform:
